...
from fazcord.app._asset import Asset
...
class Properties:
    ...
    def _read_env(cls) -> None:
        ...
        cls.DISCORD_LOG_WEBHOOK = cls._must_get_env("FAZCORD_DISCORD_LOG_WEBHOOK")
        cls.DISCORD_STATUS_WEBHOOK = cls._must_get_env("FAZCORD_DISCORD_STATUS_WEBHOOK")
        cls.FAZCORD_DB_MAX_RETRIES = cls._must_get_env("FAZCORD_DB_MAX_RETRIES", int)
